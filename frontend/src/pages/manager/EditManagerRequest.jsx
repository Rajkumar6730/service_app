...
const EditManagerRequest = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await managerService.updateRequest(requestToEdit.id, payload);
  ...
  return (
    <div>
      <div className="mb-4">
        <h1 style={{ fontSize: '1.875rem', fontWeight: 700, color: 'var(--text-main)' }}>Edit Request (Manager)</h1>
        <p className="text-muted">Update the details of this service request below.</p>
      </div>
...
export default EditManagerRequest;
