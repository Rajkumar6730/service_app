  ...
  return (
    <div>
      <div className="mb-4">
        ...
        <p className="text-muted">View your technician account details.</p>
      </div>
      ...
      <div className="card" style={{ maxWidth: '600px' }}>
        ...
        <div className="card-body">
          ...
          <div className="mt-4">
            ...
            <p className="text-muted mt-2" style={{ fontSize: '0.75rem' }}>* Profile updates are restricted in this portal.</p>
          </div>
        </div>
      </div>
    </div>
